...
export default class Bookrequest extends Component {
  ...
  renderItem = ({item,i})=>{
    return(
      <TouchableHighlight style = {{backgroundColor:'magenta',alignItems:'center'}}
      activeOpacity={0.7}
      underlayColor="blue"
      onPress={()=>{
        this.setState({Flatlist:false,bookname:item.volumeinfo.title})
      }}bottomDivider>
...
return(
      <View style={{flex:1}}>
        <Myheader title="request book" navigation ={this.props.navigation}/>
          ...
          {this.state.Flatlist?(< Flatlist data = {this.state.datasource} renderItem = {this.renderItem}
